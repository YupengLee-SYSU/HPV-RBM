...
class RBM:
    ...
    def fit(self,
        ...
        for e in range(n_epoches):
            ...
            self.iter_error.append(epoch_errs.mean())
            if verbose:
    ...
    def save_params(self, filename):
        saver = tf.train.Saver({'weights': self.w, 'hidden_bias': self.hidden_bias})
        return saver.save(self.sess, filename)
    ...
    def compute_hidden_states(self, inputs):
        return self.sess.run(self.compute_hidden, feed_dict={self.x: inputs})